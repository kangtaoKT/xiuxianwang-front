            ...
            <div className={style['find']}>
                ...
                <div>
                    <div className={style["show"]}>
                        <ul className="show-list" style={{marginTop:this.state.marginTopOne}}>
                            {
                                this.state.arr.map((obj,index) => (
                                    <li key={index} className={style["number"]} >{obj}</li>
                                ))
                            }
                        </ul>
                    </div>
                    <div className={style["show"]}>
                        <ul className={style["show-list"]} style={{marginTop:this.state.marginTopTwo}}>
                            {
                                this.state.arr.map((obj,index) => (
                                    <li key={index} className={style["number"]} >{obj}</li>
                                ))
                    ...
                    <div className={style["show"]}>
                        <ul className={style["show-list"]} style={{marginTop:this.state.marginTopThree}}>
                            {
                                this.state.arr.map((obj,index) => (
                                    <li key={index} className={style["number"]} >{obj}</li>
                                ))
                    ...
                    <div className={style["show"]}>
                        <ul className={style["show-list"]} style={{marginTop:this.state.marginTopFour}}>
                            {
                                this.state.arr.map((obj,index) => (
                                    <li key={index} className={style["number"]} >{obj}</li>
                                ))
                    ...
                    <div className={style["show"]}>
                        <ul className={style["show-list"]} style={{marginTop:this.state.marginTopFive}}>
                            {
                                this.state.arr.map((obj,index) => (
                                    <li key={index} className={style["number"]} >{obj}</li>
                                ))
                    ...
                    <div className={style["show"]}>
                        <ul className={style["show-list"]} style={{marginTop:this.state.marginTopSix}}>
                            {
                                this.state.arr.map((obj,index) => (
                                    <li key={index} className={style["number"]} >{obj}</li>
                                ))
